...
class EmployeeComponent extends Component {
  ...
  componentDidMount() {
    EmployeeService.getEmployee().then((response) => {
      const employeeDto = response.data.employeeDto;
      const departmentDto = response.data.departmentDto;
      const organizationDto = response.data.organizationDto;
      this.setState({ employee: employeeDto });
      this.setState({ department: departmentDto });
      this.setState({ organization: organizationDto });
